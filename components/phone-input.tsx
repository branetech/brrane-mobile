...
const countries: Country[] = [
    { code: 'NG', name: 'Nigeria', dialCode: '+234', flag: '🇳🇬', format: '### ### ####', maxLength: 10 },
    ...
    { code: 'JP', name: 'Japan', dialCode: '+81', flag: '🇯🇵', format: '###-####-####', maxLength: 11 },
];
...
export const PhoneInput: React.FC<PhoneInputProps> = ({
    ...
    const formatPhoneNumber = (text: string, country: Country): string => {
        ...
        for (let i = 0; i < country.format.length && digitIndex < limited.length; i++) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                <View style={[styles.phoneInputContainer,  {
                    ...
                    <ThemedText style={[disabled && styles.dialCodeDisabled, {fontSize: 12}]}>
                        {selectedCountry.dialCode}
                    </ThemedText>
                    <TextInput
                        style={[styles.phoneInput, disabled && styles.phoneInputDisabled, error && styles.inputContainerError, {color: theme.text}]}
